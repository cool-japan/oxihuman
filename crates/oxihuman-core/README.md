...
**Status:** Stable | **Tests:** 4,907 passing | **API:** 6,042 public items | **Files:** 823 .rs files | **Version:** 0.1.0 | **Updated:** 2026-03-11
...
All public items in this crate follow semantic versioning. The 0.1.0 release is considered stable for downstream consumption within the OxiHuman workspace. Breaking changes will be accompanied by a minor-version bump until a 1.0 release is declared.
